...
EXPLICACIÓN:
Creé una baraja completa de póker, después hice una función que generara la baraja de forma aleatoria sin repetir ninguna carta y puse dos botones; uno de ellos genera las cartas hasta mostrarlas todas y al final sale una alerta; y el otro refresca la página.
